...
public class MockStarWarsApiDataReader : IApiReader
{
    ...
    {
        if (BaseUrl != ExpectedBaseAddress)
        {
            throw new ArgumentException(
                $"Base address can only be {ExpectedBaseAddress}");
        }
        if (RequestPath != ExpectedRequestUri)
        {
            throw new ArgumentException(
